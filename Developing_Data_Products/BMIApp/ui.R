...
shinyUI(pageWithSidebar(
        ...
        sidebarPanel(
                ...
                p(strong(em("Github repository:",a("Developing Data Products - Peer Assessment Project; Shiny App",href="https://github.com/vsharma1/DataScienceCoursera/tree/master/Developing_Data_Products"))))
        ),
        mainPanel(
                tabsetPanel(
